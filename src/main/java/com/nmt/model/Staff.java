...
public class Staff implements Serializable {
    ...
    public Staff(String id, String name, Date birthday, short gender, String phone, String address, String email, String position) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "com.nmt.model.Staff[ id=" + id + " ]";
    }
